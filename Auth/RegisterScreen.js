...
const RegisterScreen = ({ navigation }) => {
  ...
  const handleRegister = async (values) => {
    ...
    try {
      ...
      const response = await axios.post('http://172.16.50.81:5000/api/register', {
        email,
        password,
        role,
      });
  ...
  return (
    <View style={styles.container}>
      <Image
        source={{ uri: 'https://img.freepik.com/free-photo/close-up-woman-taking-photo-her-friend-mobile-phone_23-2148129276.jpg?ga=GA1.1.605566897.1725475014&semt=ais_hybrid' }} // Logo URL
        style={styles.logo}
      />
      <ScrollView>
