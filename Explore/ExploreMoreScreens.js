...
const ExploreMoreScreen = () => {
  ...
  const carouselItems = [
    ...
    { id: '2', title: 'Best Deals For You', image: 'https://img.freepik.com/premium-photo/audience-watching-concert-stage-night-concert-club_152520-770.jpg?ga=GA1.1.605566897.1725475014&semt=ais_hybrid' },
    { id: '3', title: 'Discover Our Features', image: 'https://img.freepik.com/premium-photo/people-walking-through-subway-station-colorful-lighting-night_665346-87302.jpg?ga=GA1.1.605566897.1725475014&semt=ais_hybrid' },
  ];
